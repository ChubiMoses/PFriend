...
class _MapViewState extends State<MapView> {
  ...
  void setCircle(double lat, double long,){
                      ...
                      shrinkWrap: true,
                       itemBuilder: (context, DataSnapshot snapshot, Animation<double>animation, int index){
                           return  GestureDetector(
                            onTap:()=>Navigator.push(context, MaterialPageRoute(builder:(context)=>StationDetail(station:stations[index]))),
                            child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(
                                          image:DecorationImage(
                                            image:NetworkImage(stations[index].image),
                                            fit: BoxFit.cover,
                                          )
                                        ),
                                      ),
                                          ...
                                          SizedBox(width:5.0,),
                                           CircleAvatar(
                                             child: IconButton(
                                               ...
                                               onPressed:()=>_launchPhone("tel:${stations[index].phone}"),
                                               ),
