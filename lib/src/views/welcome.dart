              ...
              child: Column(
               children: <Widget>[
                 ...
                 Padding(
                   ...
                   child: Text("Police is your friend, our job is to protect you!",
                   textAlign: TextAlign.center,
                 ...
                 children:[
                  Padding(
                   ...
                   child:Column(
                        ...
                        children: <Widget>[
                            Text("By continuing you accept our", style: TextStyle(fontSize:14.0,color:Colors.white,)),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children:<Widget>[
                              GestureDetector(
                                //  onTap:()=>launchURL("https://cbt-exams-bc05c.web.app/scholar_terms.html"),
                                child: Text("Term of use ", style: TextStyle(fontSize:16.0, fontWeight: FontWeight.bold,color: Colors.white,)),
                              ),
                              
                                Text("and ", style: TextStyle(fontSize:14.0,color: Colors.white,)),
                                GestureDetector(
                                 // onTap:()=>launchURL("https://cbt-exams-bc05c.web.app/scholar_privacy.html"),
                                child: Text("Privacy Policy ", style: TextStyle(fontSize:16.0,fontWeight: FontWeight.bold, color: Colors.white,)),
                              )
                            ]
                          )
                        ],
